...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130220603691.png)

图片中的C代码包含了一段URL居然能成功编译和运行。

原因是在C99标准下，URL可被巧妙利用为代码的一部分。代码中` https://susam.net`的`https:`被解释为了一个标签（`label`），随后的`//`是注释标识，直至下一行。
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130210602564.png)
...
### [谷歌Antigravity数据泄露](https://www.promptarmor.com/resources/google-antigravity-exfiltrates-data)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130211631311.png)
...
### [Zig 从 GitHub 迁移到 Codeberg](https://ziglang.org/news/migrating-from-github-to-codeberg/)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130212341280.png)
...
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130211057743.png)
...
### [“优秀的工程管理” 是一种时尚](https://lethain.com/good-eng-mgmt-is-a-fad/)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130213112868.png)
...
作者提出了八项基础工程管理技能，分为核心技能和成长技能。核心技能包括执行能力、团队建设、所有权和对齐，这些是所有管理角色的基础。成长技能包括品味、清晰度、应对模糊性和跨时间尺度工作，这些技能决定了职业发展的高度。
 ### [把人工智能生成的代码当作草稿对待](https://addyo.substack.com/p/treat-ai-generated-code-as-a-draft)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130203930997.png)
...
## 技术博客
### [构建一个真正有效的简易搜索引擎](https://karboosx.net/post/4eZxhBon/building-a-simple-search-engine-that-actually-works)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130212534856.png)

本文介绍了一种简单高效的自建搜索引擎方案，核心在于利用现有数据库实现高效检索。该方案通过分词（tokenization）技术，将文本内容分解为单词、前缀和n-gram等不同粒度的分词单元，并赋予不同权重存储于数据库中。数据库结构包括`index_tokens`表存储分词及其权重，`index_entries`表关联分词与文档并记录最终权重。分词器包括单词分词器（WordTokenizer）、前缀分词器（PrefixTokenizer）和n-gram分词器（NGramsTokenizer），分别针对精确匹配、部分匹配和模糊匹配需求。索引服务负责将文档内容通过分词器处理后存入数据库，搜索服务则对用户查询进行相同分词处理，通过SQL查询匹配分词并计算文档相关性得分。该方案支持自定义分词器和文档类型，通过调整权重和SQL查询可灵活优化搜索效果。
### [适用于长期运行智能体的高效控制机制](https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130213543730.png)
...
### [Claude 智能体技能：基于第一性原理的深度探究](https://leehanchung.github.io/blogs/2025/10/26/claude-skills-deep-dive/)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130214608425.png)
...
## 开源项目 
### [VideoCaptioner：卡卡字幕助手](https://github.com/WEIFENG2333/VideoCaptioner)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130215758155.png)

VideoCaptioner 是一款基于大语言模型（LLM）的视频字幕处理工具，支持语音识别、字幕断句、优化、翻译全流程处理。
### [Everywhere：情境感知AI助手](https://github.com/DearVa/Everywhere)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130215509102.png)
...
### [xan： CSV 文件处理工具](https://github.com/medialab/xan)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130220151492.png)
...
## 工具推荐
### [免费白嫖Claude Opus 4.5, Sonnet 4.5 & Haiku 4.5 ](https://openclaude.me/chat)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130203215307.png)

提供完全免费的Claude模型（包括Opus 4.5、Sonnet 4.5和Haiku 4.5）访问权限，无需等待名单或高级订阅。每个模型每天有300K的代币限制，且提供免费的网络搜索和代码执行工具。
### [Nano Banana Pro提示词推荐](https://youmind.com/zh-CN/nano-banana-pro-prompts)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130210922110.png)

各种类型的Nano Banana Pro提示词参考。
### [播客创作AI 工具ListenHub](https://listenhub.ai/zh)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130212120528.png)
...
## 资源推荐
### [上下文工程指南](https://weaviate.io/ebooks/the-context-engineering-guide)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130203716416.png)
...
### [Linux 内核学习工具](https://reverser.dev/linux-kernel-explorer)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130215203708.png)

一个用于探索 Linux 内核代码的在线工具，旨在帮助用户更好地理解和学习 Linux 内核的结构和功能。它通过提供一个交互式的界面，让用户可以浏览内核代码，并配有基于“Kernel in the Mind”一文的指导。
### [OpenAI 指南和资源](https://openai.com/business/guides-and-resources/)
![](https://cdn.jsdelivr.net/gh/shawnxie94/images/images/20251130213144472.png)
